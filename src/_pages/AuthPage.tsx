...
export function AuthPage() {
    ...
    return (
        <form className="container mx-auto mt-8 p-4 flex justify-center" onSubmit={submitHandler}>
            <div>
                <div>
                ...
                <button type="submit" className="border py-2 px-4 mr-4">
                    Register
                </button>

                <button type="button" className="border py-2 px-4" onClick={loginHandler}>
                    Login
                </button>
            </div>
        </form>
